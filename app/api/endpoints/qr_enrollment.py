...
async def get_qr_enrollment(enrollment_id: UUID, store_id: UUID, re_enrollment: bool):
    return {
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "2IoJl9d3lL6p2CWw-WAgkuOst1UUYzULntrY2IRUw7A=",
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "2IoJl9d3lL6p2CWw-WAgkuOst1UUYzULntrY2IRUw7A=",
