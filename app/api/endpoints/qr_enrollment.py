...
async def get_qr_enrollment(enrollment_id: UUID, store_id: UUID, re_enrollment: bool):
    return {
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "mjzAq8WTYC--JhC5v6IRavmHon8YczZuhBbPtvecyVk=",
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "mjzAq8WTYC--JhC5v6IRavmHon8YczZuhBbPtvecyVk=",
