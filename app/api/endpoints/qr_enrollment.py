...
async def get_qr_enrollment(enrollment_id: UUID, store_id: UUID, re_enrollment: bool):
    return {
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "THO0P3BIPXkQW2ew4R5pTynpLG1UDG4DSAzdJ2hLFPI=",
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "THO0P3BIPXkQW2ew4R5pTynpLG1UDG4DSAzdJ2hLFPI=",
