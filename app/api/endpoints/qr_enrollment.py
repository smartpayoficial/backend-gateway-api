...
async def get_qr_enrollment(enrollment_id: UUID, store_id: UUID, re_enrollment: bool):
    return {
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "6gxjB3degR711j_tyk0S1d_xHbeVqVDvNgHjs_fhy-M=",
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "6gxjB3degR711j_tyk0S1d_xHbeVqVDvNgHjs_fhy-M=",
