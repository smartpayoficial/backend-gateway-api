...
async def get_qr_enrollment(enrollment_id: UUID, store_id: UUID, re_enrollment: bool):
    return {
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "tDTZfgPRrUKQXKtN1ELSXdlA7U9LagZYIt2QMysnWT8=",
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "tDTZfgPRrUKQXKtN1ELSXdlA7U9LagZYIt2QMysnWT8=",
