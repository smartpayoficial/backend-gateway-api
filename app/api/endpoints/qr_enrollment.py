...
async def get_qr_enrollment(enrollment_id: UUID, store_id: UUID, re_enrollment: bool):
    return {
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "raBZ0M0QGNDGcpYwBpHmbD_Vs1scBr0DV-HHxAEWjCw=",
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "raBZ0M0QGNDGcpYwBpHmbD_Vs1scBr0DV-HHxAEWjCw=",
