...
async def get_qr_enrollment(enrollment_id: UUID, store_id: UUID, re_enrollment: bool):
    return {
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "bkz9lf3ItdiJaVI5d2vgwDLYepBzUUV49g-SWopcpDQ=",
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "bkz9lf3ItdiJaVI5d2vgwDLYepBzUUV49g-SWopcpDQ=",
