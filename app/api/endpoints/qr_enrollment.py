...
async def get_qr_enrollment(enrollment_id: UUID, store_id: UUID, re_enrollment: bool):
    return {
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "eizmX3cH-0XHkk7XMdpkmruddifg_SiJmxSaerZgPXs=",
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "eizmX3cH-0XHkk7XMdpkmruddifg_SiJmxSaerZgPXs=",
