...
async def get_qr_enrollment(enrollment_id: UUID, store_id: UUID, re_enrollment: bool):
    return {
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "szqACDdqroCbr1NHYsc589aMG57DVEvpdDr5zwt-a-M=",
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "szqACDdqroCbr1NHYsc589aMG57DVEvpdDr5zwt-a-M=",
